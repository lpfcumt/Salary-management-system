...
<body>
	<table class="easyui-datagrid" title="Basic DataGrid" style="width:362px "
		...
		<thead>
			<tr>
				<th bgcolor="#F0F0F0" data-options="field:'phone',width:160">效益情况</th>
				<th bgcolor="#F0F0F0" data-options="field:'home',width:160">效益工资</th>
    ...
    <div>
        <h2>新增业绩等级</h2>
        <form> 
		业绩&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" /></br>
        </br>
        业绩工资&nbsp;&nbsp;<input type="text" /></br>
        </br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="login_no_qlogin" id="login">        
            <div id="header" class="header">
                <div class="switch" id="switch">                   
                    <a class="switch_btn_focus" id="switch_login" href="javascript:void(0);" tabindex="8">工资设定-效益工资</a>
