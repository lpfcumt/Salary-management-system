...
<br>
    ...
    <table class="easyui-datagrid" title="Basic DataGrid" style="width:1202px "
		...
		<c:forEach items="${sessionScope.listattendance}" var="listattendance">
			<tr>
			<td bgcolor="#F0F0F0" data-options="field:'itemid',width:100">${listattendance.sid}</td>
			<td bgcolor="#F0F0F0" data-options="field:'itemid',width:100">${listattendance.staffname}</td>
			<td bgcolor="#F0F0F0" data-options="field:'itemid',width:100">${listattendance.year}</td>
			<td bgcolor="#F0F0F0" data-options="field:'itemid',width:100">${listattendance.month}</td>
			<td bgcolor="#F0F0F0" data-options="field:'itemid',width:100">${listattendance.status}</td>
			<td data-options="width:120" >${listattendance.latetimes}</td>
			<td data-options="width:120">${listattendance.deduction1}</td>
			<td data-options="width:120">${listattendance.leavetimes}</td>
			<td data-options="width:120">${listattendance.deduction2}</td>
			<td data-options="width:120">${listattendance.shulddays}</td>
			<td data-options="width:120">${listattendance.realdays}</td>
			<td data-options="width:120">${listattendance.deduction3}</td>
