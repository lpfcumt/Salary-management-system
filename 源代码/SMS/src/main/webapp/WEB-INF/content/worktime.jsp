...
<body>
	<table class="easyui-datagrid" title="Basic DataGrid" style="width:362px "
		...
		<thead>
			<tr>
				<th bgcolor="#F0F0F0" data-options="field:'phone',width:160">工龄（年）</th>
				<th bgcolor="#F0F0F0" data-options="field:'home',width:160">工龄工资</th>
				<th bgcolor="#F0F0F0" data-options="field:'option',width:120">操作1</th>
                <th bgcolor="#F0F0F0" data-options="field:'option2',width:120">操作5</th>
			</tr>
		</thead>
		<tbody>
			<tr>
    ...
    <div>
        <h2>新增工龄</h2>
        <form> 
		工龄&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" /></br>
        </br>
        工龄工资&nbsp;&nbsp;<input type="text" /></br>
        </br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
